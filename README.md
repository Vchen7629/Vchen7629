...
## My Teck Stack
[![My Skills](https://skillicons.dev/icons?i=ts,js,python,go,java,html,css,bash,fastapi,spring,flask,react,express,nodejs,ansible,terraform,aws,kubernetes,docker,githubactions,tailwind,postman,vite,postgres,mongo,redis,prometheus,grafana,ansible,terraform&perline=10)](https://skillicons.dev)
